...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c2 = new CommentDTO("Aproveite!", LocalDate.of(2018, 03, 22), new AuthorDTO(bob));
        CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", LocalDate.of(2018, 03, 23), new AuthorDTO(alex));
